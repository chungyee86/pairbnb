...
class UsernamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create username" do
    assert_difference('Username.count') do
      post usernames_url, params: { username: { email: @username.email, login: @username.login, name: @username.name } }
    end
  ...
  test "should update username" do
    patch username_url(@username), params: { username: { email: @username.email, login: @username.login, name: @username.name } }
